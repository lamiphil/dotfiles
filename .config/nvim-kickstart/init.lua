...
-- Disable line wrap globally (re-enabled for markdown below)
vim.o.wrap = false
...
-- NOTE: <C-h/j/k/l> split navigation is handled by vim-tmux-navigator plugin
...
vim.keymap.set('n', '<leader>so', '<cmd>only<CR>', { desc = 'Keep focused only' })

-- Diagnostic float popup
...
-- Enable line wrap for Markdown files (global wrap is disabled above)
...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- NOTE: mini.statusline has been replaced by lualine.nvim
      --  See `lua/custom/plugins/lualine.lua` for the statusline configuration
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local parsers = {
        ...
        'markdown', 'markdown_inline', 'python', 'query', 'typescript', 'tsx',
        'vim', 'vimdoc',
      }
